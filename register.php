...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($id_number) || empty($last_name) || empty($first_name) ||
        ...
        if ($stmt->rowCount() > 0) {
            $error = "That ID number is already registered. Please login instead.";
        } else {
            // Save to database
            ...
            $stmt->execute([
                ...
                $course, $year_level, $email, $address, $hashed_password
            ]);
        ...
        <div class="card">
            ...
            <?php if (!empty($success)): ?>
                <div class="alert alert-success">
                    ...
                    <br><br><a href="login.php" style="color:#2e7d32;font-weight:bold;">→ Click here to Login</a>
                </div>
            <?php endif; ?>
